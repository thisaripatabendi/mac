        ...
        info = @Info(
                ...
                extensions = {
                        @Extension(properties = {
                                @ExtensionProperty(name = "name", value = "mac"),
                                @ExtensionProperty(name = "context", value = "/mac"),
                        })
                }
        ),
        tags = {
                @Tag(name = "mac", description = "")
        }
)
@Scopes(
        scopes = {
                @Scope(
                        ...
                        description = "",
                        key = "perm:mac:enroll",
                        permissions = {"/device-mgt/devices/enroll/mac"}
                )
        }
)
...
public interface DeviceTypeService {
    ...
    @ApiOperation(
            ...
            extensions = {
                    @Extension(properties = {
                            @ExtensionProperty(name = SCOPE, value = "perm:mac:enroll")
                    })
            }
    )
