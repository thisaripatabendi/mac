...
package org.laptop.mac.api;

import org.laptop.mac.api.dto.DeviceJSON;
import org.laptop.mac.api.dto.SensorRecord;
import org.laptop.mac.api.util.APIUtil;
import org.laptop.mac.api.util.ZipUtil;
import org.laptop.mac.api.util.ZipArchive;
...
public class DeviceTypeServiceImpl implements DeviceTypeService {
    ...
    public Response changeStatus(@PathParam("deviceId") String deviceId,
        ...
        try {
            ...
            deviceIdentifiers.add(new DeviceIdentifier(deviceId, "mac"));
            APIUtil.getDeviceManagementService().addOperation("mac", commandOp,
                                                              deviceIdentifiers);
