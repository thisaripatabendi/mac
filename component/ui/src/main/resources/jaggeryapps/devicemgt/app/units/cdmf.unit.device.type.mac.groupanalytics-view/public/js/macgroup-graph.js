...
var sensorType1 = "macbatterylevel";
var sensorType2 = "macbatterystatus";
//cpuusage
var sensorType3 = "maccpuusage";
var sensorType1Graph;
var sensorType2Graph;
//cpuusage
var sensorType3Graph;

function drawGraph_mac(from, to)
{
        ...
        for (var d = 0 ; d < Deviceids.length ; d++){
            ...
            for (var z = 0 ; z < dataset.length ; z++){
                ...
                if (placeHolder == "chartSensorType1"){
                    value = dataset[z].values.macbatterylevel;
                }else if (placeHolder == "chartSensorType2"){
                    value = dataset[z].values.macbatterystatus;
                }else{
                    value = dataset[z].values.maccpuusage;
                }
