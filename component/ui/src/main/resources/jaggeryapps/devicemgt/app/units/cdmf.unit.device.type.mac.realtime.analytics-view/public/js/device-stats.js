    ...
    if (wsConnection) {
        wsConnection.onmessage = function (event) {
            ...
            if(currentDevId == deviceId){
                if(dataPoint.event.payloadData.macbatterylevel !== undefined){
                    value = value = dataPoint.event.payloadData.macbatterylevel;
                }else if (dataPoint.event.payloadData.macbatterystatus !== undefined){
                    value = value = dataPoint.event.payloadData.macbatterystatus;
                }else{
                    value = value = dataPoint.event.payloadData.maccpuusage;
                }
