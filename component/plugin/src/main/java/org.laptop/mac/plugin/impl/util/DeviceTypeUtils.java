...
package org.laptop.mac.plugin.impl.util;
...
/**
 * Contains utility methods used by mac plugin.
 */
public class DeviceTypeUtils {

    private static Log log = LogFactory.getLog(org.laptop.mac.plugin.impl.util.DeviceTypeUtils.class);
