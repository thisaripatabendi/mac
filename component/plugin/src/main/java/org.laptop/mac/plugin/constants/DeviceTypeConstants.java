...
package org.laptop.mac.plugin.constants;
...
public class DeviceTypeConstants {
    public final static String DEVICE_TYPE = "mac";
    public final static String DEVICE_PLUGIN_DEVICE_NAME = "DEVICE_NAME";
    public final static String DEVICE_PLUGIN_DEVICE_ID = "mac_DEVICE_ID";
    public final static String STATE_ON = "ON";
    public final static String STATE_OFF = "OFF";

    //sensor events summerized table name
    public static final String SENSOR_TYPE1_EVENT_TABLE = "ORG_WSO2_IOT_DEVICES_MACBATTERYLEVEL";
    public static final String SENSOR_TYPE2_EVENT_TABLE = "ORG_WSO2_IOT_DEVICES_MACBATTERYSTATUS";
    public static final String SENSOR_TYPE3_EVENT_TABLE = "ORG_WSO2_IOT_DEVICES_MACCPUUSAGE";
    public static final String DATA_SOURCE_NAME = "jdbc/macDM_DB";
    public final static String DEVICE_TYPE_PROVIDER_DOMAIN = "carbon.super";
    public final static String SENSOR_TYPE1 = "macbatterylevel";
    public final static String SENSOR_TYPE2 = "macbatterystatus";
    public final static String SENSOR_TYPE3 = "maccpuusage";

    //mqtt tranport related constants
    public static final String MQTT_ADAPTER_NAME = "macbatterylevel_mqtt";
    ...
    public static final String SUBSCRIBED_TOPIC = "carbon.super/mac/+/macbatterylevel";
    ...
    public final static String SENSOR_TYPE1_STREAM_DEFINITION = "org.wso2.iot.devices.macbatterylevel";
    public final static String SENSOR_TYPE1_STREAM_DEFINITION_VERSION = "1.0.0";

    public final static String SENSOR_TYPE2_STREAM_DEFINITION = "org.wso2.iot.devices.macbatterystatus";
